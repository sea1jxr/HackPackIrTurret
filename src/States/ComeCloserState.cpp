...
char * ComeCloserState::GetStateName()    
{
    return "Come Closer";
}

void ComeCloserState::HandleCommand(int command)
{
...
int loopCount = 0;
void ComeCloserState::DoLoopWork()
{
    if (loopCount++ % 50 == 0)
    {
...
{
    u8g2.drawXBM(55, 19, 11, 16, image_crosshairs_bits);
    char * stateText = sprintf("%.02f in")
    u8g2.drawStr(67, 31, stateText);
}